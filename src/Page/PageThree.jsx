...
export default function PageThree() {
    ...
    return (
        <>
            ...
            `}</style>
                <div ref={pageRef} className=" bg-[#F0F0F0] h-auto flex items-center justify-center flex-wrap px-8 mt-20 mb-30">
                            ...
                            <div className="flex flex-col gap-4 lg:ml-40 md:w-1/2 ml-5">
                                ...
                                <h1 className={`text-4xl -mt-4 underline font-bold text-[#457476] ${isVisible ? 'animate-fade-right delay-500' : ''}`}>About Me</h1>
