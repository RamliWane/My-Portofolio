    ...
    <div className="flex space-x-4 mt-5">
        <div className="flex flex-col justify-start">
            ...
            <div className="flex gap-3 mt-5">
                <div className="flex bg-[#F0F0F0] w-13 shadow-2xl h-13 rounded-xl cursor-pointer transition-transform hover:scale-105">
                ...
                <div className="flex bg-[#F0F0F0] shadow-2xl w-13 h-13 rounded-xl cursor-pointer transition-transform hover:scale-105">
