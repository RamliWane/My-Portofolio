    ...
    return (
        <AnimatedWrapper animation={animation} delay={delay}>
            <div className="flex flex-wrap justify-center gap-5 mt-5">
                <div className="bg-pink-100 max-w-sm h-80 rounded-3xl p-4 flex flex-col cursor-pointer transition-transform duration-150 ease-in-out hover:scale-95 shadow-lg">
